...
const jsonData = [
  ...
  { "S.NO": 3, "City": "Cheonan-si","Part_number": "40AY0090EU", "Quantity": 1,  "": "520222.50" },
...
var Part_numberjs = [
  { "Part_number": "4X41A30364", "Inventory": [0, 0, 0, 0, 0, 4], "Avg_demand": [2, 2, 2.3, 3.5, 4, 4.3], "Predicted": [0, 0, 0, 0, 0, 7] },
  { "Part_number": "4X41A30364", "Inventory": [0, 0, 0, 0, 0, 2], "Avg_demand": [2, 4, 3.6, 3.5, 4.2, 3.6], "Predicted": [0, 0, 0, 0, 0, 7] },
  { "Part_number": "40AY0090EU", "Inventory": [0, 0, 0, 0, 0, 1], "Avg_demand": [0, 0.5, 0.6, 0.75, 0.6, 0.5], "Predicted": [0, 0, 0, 0, 0, 1] },
  { "Part_number": "40AY0090EU", "Inventory": [0, 0, 0, 0, 0, 0], "Avg_demand": [0, 0, 0, 0.25, 0.2, 0], "Predicted": [0, 0, 0, 0, 0, 1] },
  { "Part_number": "4X30L79883", "Inventory": [0, 0, 0, 0, 0, 0], "Avg_demand": [3, 2, 2.3, 2.75, 3.2, 2.83], "Predicted": [0, 0, 0, 0, 0, 8] },
  { "Part_number": "4X30L79883", "Inventory": [0, 0, 0, 0, 0, 0], "Avg_demand": [4, 2.5, 2, 2, 1.8, 1.6], "Predicted": [0, 0, 0, 0, 0, 5] },
  { "Part_number": "4X30L79883", "Inventory": [0, 0, 0, 0, 0, 0], "Avg_demand": [0, 2.5, 2, 2.5, 2.6, 2.3], "Predicted": [0, 0, 0, 0, 0, 7] },
  { "Part_number": "4Y51C21217", "Inventory": [0, 0, 0, 0, 0, 0], "Avg_demand": [3, 3.5, 3.3, 3.75, 3.2, 4], "Predicted": [0, 0, 0, 0, 0, 7] },
  { "Part_number": "4Y51C21217", "Inventory": [0, 0, 0, 0, 0, 0], "Avg_demand": [6, 5, 5.3, 5, 4.4, 4.5], "Predicted": [0, 0, 0, 0, 0, 6] },
  { "Part_number": "21EYS7CG1W", "Inventory": [0, 0, 0, 0, 0, 1], "Avg_demand": [0, 0, 0, 0.5, 1.6, 1.5], "Predicted": [0, 0, 0, 0, 0, 4] },
  { "Part_number": "21H2S7G11W", "Inventory": [0, 0, 0, 0, 0, 1], "Avg_demand": [2, 0, 2.6, 4.25, 3.4, 2.8], "Predicted": [0, 0, 0, 0, 0, 7] },
  { "Part_number": "21H2S7G11W", "Inventory": [0, 0, 0, 0, 0, 0], "Avg_demand": [0, 0, 0.3, 0.5, 0.4, 0.3], "Predicted": [0, 0, 0, 0, 0, 1] },
  { "Part_number": "21H2S7G11W", "Inventory": [0, 0, 0, 0, 0, 0], "Avg_demand": [0, 1.5, 2.3, 2.25, 1.8, 1.6], "Predicted": [0, 0, 0, 0, 0, 5] },
  { "Part_number": "63CFMARXKR", "Inventory": [0, 0, 0, 0, 0, 7], "Avg_demand": [1, 1, 3, 3.5, 3.6, 3.5], "Predicted": [0, 0, 0, 0, 0, 1] },
  { "Part_number": "63CFMARXKR", "Inventory": [0, 0, 0, 0, 0, 1], "Avg_demand": [1, 1, 0.6, 1.25, 1.4, 1.6], "Predicted": [0, 0, 0, 0, 0, 3] },
  { "Part_number": "63CFMARXKR", "Inventory": [0, 0, 0, 0, 0, 0], "Avg_demand": [0, 0, 0.3, 0.75, 0.6, 0.5], "Predicted": [0, 0, 0, 0, 0, 2] },
  { "Part_number": "4XD0X88524", "Inventory": [0, 0, 0, 0, 0, 6], "Avg_demand": [0, 2.5, 3, 3.25, 4.2, 3.6], "Predicted": [0, 0, 0, 0, 0, 1] },
  { "Part_number": "4XD0X88524", "Inventory": [0, 0, 0, 0, 0, 5], "Avg_demand": [3, 2.5, 2.6, 3, 2.8, 2.5], "Predicted": [0, 0, 0, 0, 0, 1] },
  { "Part_number": "4XJ1M77973", "Inventory": [0, 0, 0, 0, 0, 0], "Avg_demand": [1, 0.5, 0.6, 2, 0.4, 0.5], "Predicted": [0, 0, 0, 0, 0, 1] },
  { "Part_number": "4XJ1K79629", "Inventory": [0, 0, 0, 0, 0, 0], "Avg_demand": [1, 0.5, 0, 0, 0, 0], "Predicted": [0, 0, 0, 0, 0, 1] },
  { "Part_number": "4XD1M45626", "Inventory": [0, 0, 0, 0, 0, 0], "Avg_demand": [0, 0, 0, 0, 0, 0], "Predicted": [0, 0, 0, 0, 0, 2] }
];
...
function populateTable() {
  ...
  <td class="border-bottom-0"><p class="fw-semibold mb-0 fs-4">${item.Total_Cost}</p></td>
      ...
      row.addEventListener('click', function () {
          ...
          const selectedPart_number = item.Part_number;
          const selectedPart_numberData = Part_numberjs.find(prodItem => prodItem.Part_number === selectedPart_number);

          if (selectedPart_numberData) {
              updateBarChart(selectedPart_numberData.Inventory, selectedPart_numberData.Avg_demand, selectedPart_numberData.Predicted);
          }
      });
  ...
  // Automatically call the function for the first Part_number after table load
  if (Part_numberjs.length > 0) {
      updateBarChart(Part_numberjs[0].Inventory, Part_numberjs[0].Avg_demand, Part_numberjs[0].Predicted);
  }
}
